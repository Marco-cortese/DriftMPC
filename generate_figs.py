...
ramp = np.concatenate((np.linspace(0., 1., int(len(tzero_ref)/2)), np.linspace(1., 0., len(tzero_ref)-int(len(tzero_ref)/2)))).reshape(-1,1)
assert ramp.shape == beta_ref0.shape, f'ramp {ramp.shape} must have the same shape as beta_ref0 {beta_ref0.shape}'
...
TESTS = [
    ...
    Test(title='Sinusoidal β reference 1, w:[1e2, 1e3, 0, 0, 0, 1e1, 1e-3]\nwith model mismatch and measurement noise, SQP_RTI',
        V_ref=([x_eq0[0]], [1]), 
        beta_ref=beta_ref0, 
        r_ref=([0], [1]), 
        delta_ref=([0], [1]), 
    ...
    Test(title='Sinusoidal β reference 2, w:[1e2, 1e3, 0, 0, 0, 1e1, 1e-3]\nwith model mismatch and measurement noise, SQP_RTI',
        V_ref=([x_eq0[0]], [1]), 
        beta_ref=beta_ref1, 
        r_ref=([0], [1]), 
        delta_ref=([0], [1]), 
    ...
    Test(title='V Steps, w:[1e2, 1e3, 0, 0, 0, 1e1, 1e-3]\nwith model mismatch and measurement noise, SQP_RTI',
    ...
    Test(title='β Steps, w:[1e2, 1e3, 0, 0, 0, 1e1, 1e-3]\nwith model mismatch and measurement noise, SQP_RTI',
        V_ref=([6.], [1.]),
    ...
    Test(title='β Ramps, w:[1e2, 1e3, 0, 0, 0, 1e1, 1e-3]\nwith model mismatch and measurement noise, SQP_RTI',
        V_ref=([5], [1]),
    ...
    Test(title='V Ramps, w:[1e2, 1e3, 0, 0, 0, 1e1, 1e-3]\nwith model mismatch and measurement noise, SQP_RTI',
        V_ref=3+7*ramp,
        beta_ref=([-25*π/180], [1]),
        r_ref=([0], [1]), 
        delta_ref=([0], [1]), 
    ...
    Test(title='Steps β and V, w:[1e2, 1e3, 0, 0, 0, 1e1, 1e-3]\nwith model mismatch and measurement noise, SQP_RTI',
